# Changelog — Legacy (pre-3.0)

History of Macula SDK releases before the 3.0.0 wire-format
cutover (MessagePack → CBOR via RFC 8949). Every release here is
**wire-incompatible** with current 3.x SDK; nothing in this file
applies to a current consumer except as historical context. See
`CHANGELOG.md` for 3.0.0 onwards.
...
- Docker deployments require proper file ownership (pass --chown=app:app)
