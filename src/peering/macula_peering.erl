...
%% `send_on_stream/2' and `macula_quic:*', and receives the stream's
...
%% given and nothing else. Synchronous: the underlying NIF write can
%% block briefly on QUIC flow-control credit, same as any other
%% `macula_quic:send/2' call.
