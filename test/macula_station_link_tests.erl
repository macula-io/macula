...
%% overlay frames, inbound calls and streams. Outbound calls are in
%% macula_station_link_call_tests, liveness in
%% macula_station_link_liveness_tests and advertising in
%% macula_station_link_advertise_tests. Peering is exercised by injecting
