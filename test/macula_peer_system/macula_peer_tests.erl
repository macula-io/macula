%%%-------------------------------------------------------------------
%%% @doc
%%% EUnit tests for macula_peer module (mesh participant facade).
%%% Tests high-level peer API behavior.
%%% @end
%%%-------------------------------------------------------------------
-module(macula_peer_tests).
...
parse_url_https_test() ->
    ...
    ?assert(erlang:function_exported(macula_peer, start_link, 2)).
