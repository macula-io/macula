...
### Cluster
A logical group of nodes that form an Erlang cluster, through gossip (UDP multicast) or a static node list; see the [Clustering Guide](guides/CLUSTERING_GUIDE.md). LAN clustering works independently of relay connections.
