...
**Complete guide to RPC with DHT-based service discovery over the relay mesh**
...
Macula provides **relay-routed RPC** without requiring any central registry or broker. Services advertise themselves via the relay mesh, and the Kademlia DHT between relays handles procedure discovery. Consumers discover providers by querying their relay, which routes lookups through the DHT.
...
- [Quick Start Guide](../../README.md) - Getting started tutorial
