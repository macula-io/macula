...
- Identity key generation with the node_id, OTP 28.4.2, one core: ML-DSA-87 with the D5 node_id takes 0.28 ms (mean
  of 200), and Ed25519 with SHA-256 of the key 0.045 ms (mean of 2,000). A puzzle of n bits takes 2^n generations on
  average: 1.1 s at 12 bits and 18 s at 16 bits for ML-DSA-87 (D30).
