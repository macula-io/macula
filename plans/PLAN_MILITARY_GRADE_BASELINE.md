...
- [x] #1: station release carrying 2cf0e8c and the D28 counter: released in v0.6.3, rolled to all six stations as v0.6.7 (2026-09-26 15:42Z).
...
- [x] #3: AES-256-only cipher suites, released in macula-pqc 0.3.0 and macula 12.7.0 (macula issue #39). All six stations run v0.6.7 and refuse an AES-128-only offer (measured 6/6, 2026-09-26); a Go client (macula-go v0.15.0) negotiates AES-256.
