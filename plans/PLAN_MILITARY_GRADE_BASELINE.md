...
**Updated 2026-09-26:** rows 1 and 3 against `macula-station` tags v0.6.3 to v0.6.7, the fleet on v0.6.7 since
15:42Z, and a wire check on paris; the rest stand as checked above.
...
- [x] #3: AES-256-only cipher suites, released in macula-pqc 0.3.0 and macula 12.7.0 (macula issue #39). All six stations run v0.6.7; the AES-128-only refusal measured on paris (2026-09-26); a Go client's AES-256 still to measure.
