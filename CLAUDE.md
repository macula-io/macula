...
**Current Version**: v3.2.0 (April 2026)
...
Macula SDK is a **53-module client library** for connecting to the Macula relay mesh. Nodes connect outbound to relays over QUIC. Relays (in [macula-relay](https://github.com/macula-io/macula-relay)) handle routing.
